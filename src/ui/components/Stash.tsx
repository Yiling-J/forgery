  ...
  if (items.length === 0) {
     return (
        <div className="text-center p-12 animate-fade-in-up">
           ...
           <h2 className="text-xl font-black text-stone-700 uppercase tracking-wide mb-2">Empty Stash</h2>
           <p className="text-stone-500 mb-8 max-w-md mx-auto">Your inventory is empty. Use the Extractor to loot equipment from character images.</p>
           <button onClick={onNavigateToExtractor} className="px-6 py-3 bg-stone-800 text-white font-bold uppercase tracking-wider rounded-lg shadow-lg hover:bg-stone-700 transition-colors">
              Go to Extractor
           </button>
        </div>
     );
  ...
  return (
    <div className="animate-fade-in-up">
       <div className="flex justify-between items-center mb-8">
          <div>
             <h2 className="text-3xl font-black text-stone-800 uppercase tracking-tighter">Your Stash</h2>
             <p className="text-stone-500 text-xs font-bold tracking-[0.2em] uppercase">{items.length} Items Collected</p>
          </div>
