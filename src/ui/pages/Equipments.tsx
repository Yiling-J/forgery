      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 pb-10">
        {loading ? (
           ...
           <div className="flex flex-col items-center justify-center h-64 border-2 border-dashed border-stone-200 rounded-xl bg-stone-50/50">
             ...
             <p className="text-stone-400 text-sm">Try adjusting your filters or extract new items.</p>
           </div>
        ) : (
              ...
              >
                ...
                <div className="p-3 border-t border-stone-100">
                  <div className="flex justify-between items-start mb-1">
                    <h3 className="text-sm font-bold text-stone-800 leading-tight truncate pr-2" title={item.name}>
                      {item.name}
                    </h3>
                  </div>
